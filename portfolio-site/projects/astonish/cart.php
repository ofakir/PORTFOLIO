    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          if(isset($_POST['update'])){
            ...
            mysqli_query($conn, "UPDATE `cart` SET `qty` = '$qty', `total_price` = '$total_price' WHERE `cart_id` = '$cart_id'") or die('query failed');
         ...
         if(isset($_POST['remove'])){
            ...
            ?>
                            <tr>
                                ...
                                <td data-th="Price"><?php echo $p_price*$qty;?>DH</td>
                                <?php $sub_total=$sub_total+($p_price*$qty); ?>
                                <td data-th="Quantity">
                                    <form action="" method="post">
                                        <input type="hidden" value="<?php echo $cart_id; ?>" name="cart_id">
                                        <input type="hidden" value="<?php echo $p_price; ?>" name="price">
   ...
   ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const subtotalElement = document.querySelector('h1');
            ...
            quantityInputs.forEach(input => {
                input.addEventListener('change', function() {
                    ...
                    const totalPriceElement = row.querySelector('[data-th="Price"]');
                    ...
                    // Update the subtotal in the DOM and the hidden input field
                    subtotalElement.textContent = `${newSubtotal}DH`;
                    subtotalInput.value = newSubtotal;
                });
            });
        });
    </script>
