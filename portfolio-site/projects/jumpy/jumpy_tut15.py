...
pygame.mixer.music.load('jumpy/assets/music.mp3')
pygame.mixer.music.set_volume(0.6)
pygame.mixer.music.play(-1, 0.0)
jump_fx = pygame.mixer.Sound('jumpy/assets/jump.mp3')
jump_fx.set_volume(0.5)
death_fx = pygame.mixer.Sound('jumpy/assets/death.mp3')
...
platform_image = pygame.image.load('jumpy/assets/wood.png').convert_alpha()
#bird spritesheet
