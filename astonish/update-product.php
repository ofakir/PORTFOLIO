...
include_once('includes/config.php');
    ...
    if (isset($_POST['submit'])) 
    {
        ...
        $qty = $_POST['qty'];
        $stock = $_POST['qty']; // Set stock to match quantity

        $sql = mysqli_query($con, "update products set p_name='$p_name',p_mrp='$p_mrp',p_price='$p_price',p_desc='$p_desc',p_img='$p_img',qty='$qty',stock='$stock',c_id='$c_id' where p_id='$p_id'");
