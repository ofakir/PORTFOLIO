  ...
  <body>
   ...
   ?>
      ...
      <div class="container">
        ...
        <div class="search-bar">
          <form action="" method="GET">
            <input type="text" name="search" placeholder="Search products..." class="form-control" style="margin-bottom: 20px;">
    ...
    if (isset($_GET['search']) && !empty($_GET['search'])) {
        ...
        $sql = "SELECT * FROM products WHERE c_id=2 AND (p_name LIKE '%$search_query%' OR p_desc LIKE '%$search_query%')";
    } else {
